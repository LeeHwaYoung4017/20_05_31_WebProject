...
public class CommunityCommentList {
	...
	private ArrayList<CommunityCommentVO> communityCommentList = new ArrayList<CommunityCommentVO>();
	...
	public CommunityCommentList() {}

	public void initCommunityCommentList(int pageSize, int totalCount, int currentPage) {
